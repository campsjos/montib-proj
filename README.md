...
Navigate to the root of your checkout:
	...
	cd path/to/your/checkout/of/montiboli
...
Everything else that has been developed by the contributions to this project is under [All rights reserved](LICENSE).
